...
_Generated 2026-07-13T06:02:38.847Z · runtime 107.6s · seed 111_
...
| kind | count |
|---|---|
| distinct findings | 18 |
| — major | 0 |
| — minor | 18 |
| mobile-only findings | 5 |
...
- **[minor] tap-target** — 2 visible interactive element(s) under 44px  
  _seen on: 4 devices_  
  e.g. `button.vtab.on 39×44`, `button.vtab 43×44`
- **[minor] tap-target** — 1 visible interactive element(s) under 44px  
  _seen on: 4 devices_  
  e.g. `button.btn.small 76×40`
- **[minor] tap-target** — 5 visible interactive element(s) under 44px  
  _seen on: 4 devices_  
  e.g. `button.btn.small 304×40`, `button.btn.small 304×40`, `button.btn.small 304×40`, `button.btn.small 304×40`, `button.btn.small 304×40`
- **[minor] tap-target** — 4 visible interactive element(s) under 44px  
  _seen on: iphone13-portrait_  
  e.g. `input#faithName 304×44`, `select#faithClergy 304×44`, `select#faithOne 304×44`, `select#faithTwo 304×44`
- **[minor] tap-target** — 3 visible interactive element(s) under 44px  
  _seen on: pixel7-portrait_  
  e.g. `button.btn.small 76×40`, `button.btn.small 76×40`, `button.btn.small 76×40`
...
- **[minor] tap-target** — 14 visible interactive element(s) under 44px  
  _seen on: desktop-1280x800_  
  e.g. `button#zoomIn.iconbtn 34×34`, `button#zoomOut.iconbtn 34×34`, `button#homeMap.iconbtn 34×34`, `button#capMap.iconbtn 34×34`, `button#scoutMap.iconbtn 34×34`
- **[minor] tap-target** — 25 visible interactive element(s) under 44px  
  _seen on: desktop-1920x1080_  
  e.g. `button#zoomIn.iconbtn 34×34`, `button#zoomOut.iconbtn 34×34`, `button#homeMap.iconbtn 34×34`, `button#capMap.iconbtn 34×34`, `button#scoutMap.iconbtn 34×34`
- **[minor] tap-target** — 22 visible interactive element(s) under 44px  
  _seen on: desktop-1920x1080_  
  e.g. `button#zoomIn.iconbtn 34×34`, `button#zoomOut.iconbtn 34×34`, `button#homeMap.iconbtn 34×34`, `button#capMap.iconbtn 34×34`, `button#scoutMap.iconbtn 34×34`
- **[minor] tap-target** — 29 visible interactive element(s) under 44px  
  _seen on: desktop-1920x1080_  
  e.g. `button#zoomIn.iconbtn 34×34`, `button#zoomOut.iconbtn 34×34`, `button#homeMap.iconbtn 34×34`, `button#capMap.iconbtn 34×34`, `button#scoutMap.iconbtn 34×34`
